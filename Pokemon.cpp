...
PokemonData FinalBoss =
    { "???", PokemonType::Chaos, PokemonRole::Attack,
    {{"혼돈의 폭발", 70, 95, PokemonType::Chaos}, {"혼돈 소용돌이", 90, 85, PokemonType::Chaos}, {"카오스 브레이크", 120, 75, PokemonType::Chaos}},
    {200, 80, 70, 85}, -1, "" };
